                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content hover-parent">
                        ...
                        <div className="modal-body py-5 py-lg-8 px-5 px-lg-8 text-center">
                            ...
                            <p className="mb-7">Signup for our weekly newsletter to get the latest news, updates and
                            ...
                            <div className="subscribe-form">
                                <form id="sf" name="sf" action="include/subscribe.php" method="post">
                                    ...
                                    <div className="form-group">
                                        <input type="email" id="sf-email" name="sf-email"
                                               placeholder="Enter Your Email Address" className="form-control required"/>
                                    </div>
                                    <input type="text" id="sf-botcheck" name="sf-botcheck" value=""
                                           className="form-control d-none"/>
                                        <button className="btn btn-primary btn-block" type="submit" id="sf-submit"
                                                name="sf-submit">Notify Me
                                        </button>
                                </form>
