// TODO CalendarChoice.tsx import React from "react";
...
class NumbersChoice extends React.Component<any, any>{
    ...
    <span className="mdc-notched-outline">
      ...
      <span className="mdc-notched-outline__trailing"></span>
                ...
                <input onChange={this.OnChange} type="number" min={1} max={7} defaultValue={1} className="mdc-text-field__input" aria-labelledby="my-label-id"  />
            </label>
            </div>
        );
    }
