...
#  Comment travailler sous GitHub

GitHub a pour vocation non seulement de gérer la vie d'un développement (source, version), mais également et surtout de pouvoir fédérer des développeurs sous un même projet, et ce sans cacophonie générale.

Afin de vous aider à vous familiariser avec GitHub, vous pouvez consulter ce [petit guide](https://rogerdudler.github.io/git-guide/index.fr.html)  pour une présentation officielle.

Ici nous allons aborder des notions de bases.
...
- Vous voulez soumettre un bug ou faire une demande d'évolution ou encore partager vos idées ? Dans ce cas il vous faut soumettre une `issue` sur le dépôt principal.
...
C'est l'étape #6 et  #10 du schéma.
